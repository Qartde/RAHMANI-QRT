            ...
            try {
                ...
                if (checksDone >= checks) {
                    ...
                    const messageData = {
                        ...
                        caption: `🟢 *RAHMANI XMD ONLINE MEMBERS* (${onlineArray.length}/${groupData.participants.length}):\n\n${onlineList}\n\n👋 _BOT IS ACTIVE AND MONITORING_ ✋`,
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterName: '🌕RAHMANI MD IS LIVE🌕',
                                serverMessageId: 143
                            }
                        }
                    };
                    ...
                    await Promise.all([
                        ...
                        conn.sendMessage(from, { 
                            audio: { url: 'https://files.catbox.moe/zqbr13.mp3' },
                            mimetype: 'audio/mp4',
                            ptt: false
                        }, { quoted: mek })
                    ]);
