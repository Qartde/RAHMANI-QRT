      ...
      if (_0x56fbde) {
        ...
        if (_0x33bcb9 === '1') {
          await _0xd77fff.sendMessage(_0x41d115, {
            ...
            'caption': "*® Gᴇɴᴇʀᴀᴛᴇᴅ Bʏ ʀᴀʜᴍᴀɴɪ xᴍᴅ*"
          }, {
            'quoted': _0x58803e
          });
        } else {
      ...
      if (_0x58b051) {
        ...
        if (_0x48db83 === "1.1") {
          await _0x1ac136.sendMessage(_0x231677, {
            ...
            'caption': "*© ᴄʀᴇᴀᴛᴇᴅ ʙʏ ʀᴀʜᴍᴀɴɪ xᴍᴅ*"
          }, {
            'quoted': _0x5ded0a
          });
        } else {
      ...
      if (_0x4dbcb0) {
        ...
        if (_0x1e75d9 === "1.1") {
          await _0xaf8db8.sendMessage(_0x5eb615, {
            ...
            'caption': "*© Gᴇɴʀᴇʀᴀᴛᴇᴅ Bʏ ʀᴀʜᴍᴀɴɪ xᴍᴅ*"
          }, {
            'quoted': _0x2405c0
          });
        } else {
            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "ʀᴀʜᴍᴀɴɪ xᴍᴅ | " + _0x1d0aed.title + '.mp4',
                  'caption': _0x1d0aed.title + " |  *ʀᴀʜᴍᴀɴɪ xᴍᴅ *\n\n> ®>ʀᴀʜᴍᴀɴɪ xᴍᴅ"
                }, {
                  'quoted': _0x171143
                });
              } else {
...
cmd({
  ...
  'react': '📑',
  'category': "download",
  'desc': "Search movies on rahmany and get download links",
  'filename': __filename
  ...
  try {
    ...
    if (_0x43e539) {
      ...
      await _0x58a7b9.sendMessage(_0x5b710a, {
        ...
        'caption': "*® Gᴇɴᴇʀᴀᴛᴇᴅ by ʀᴀʜᴍᴀɴɪ xᴍᴅ *\n\n> 2026 • ʀᴀʜᴍᴀɴɪ xᴍᴅ ✻"
      }, {
        'quoted': _0x5afcc4
      });
    }
