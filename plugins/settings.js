...
async (conn, mek, m, { from, quoted, reply }) => {
    try {
        ...
        let envSettings = `╭┄┄┅┅〔 [ • ʀᴀʜᴍᴀɴɪ xᴍᴅ sᴇᴛᴛɪɴɢs • ]* 〕┅┅┄┄⊷
┃▸╭───────────
┃▸┃➢ *ENV SETTINGS*
┃▸└───────────···๏
╰────────────────┈⊷
╭━━[ • ʀᴀʜᴍᴀɴɪ xᴍᴅ sᴇᴛᴛɪɴɢs • ]━━┈⊷
...
> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴀʜᴍᴀɴɪ xᴍᴅ `;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: 'https://files.catbox.moe/aktbgo.jpg' }, // Image URL
                caption: envSettings,
                contextInfo: {
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://files.catbox.moe/zqbr13.mp3' }, // Audio URL
            mimetype: 'audio/mp4',
            ptt: true
        }, { quoted: mek });
