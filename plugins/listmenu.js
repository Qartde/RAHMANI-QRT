...
cmd({
  ...
  try {
    ...
    const caption = `╭━━〔 *RAHMANI-QRT Command List* 〕━━⬣
...
╰━━━━━━━━━━━━━━━━━━━━⬣\n\n${commandList.join('\n\n')}`;
    ...
    await Void.sendMessage(m.chat, {
      image: { url: "https://files.catbox.moe/i9v0al.jpg" },
      caption,
      contextInfo: {
        forwardingScore: 999,
        isForwarded: true,
      ...
      message: {
        contactMessage: {
          displayName: "RAHMANI-QRT | Powered by Rahmani",
          vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:RAHMANI-QRT | Rahmani\nORG:Rahmani;\nTEL;type=CELL;type=VOICE;waid=254700000000:+254 700 000000\nEND:VCARD`,
