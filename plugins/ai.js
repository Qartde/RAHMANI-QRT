...
const fakeContact = {
  ...
  message: {
    contactMessage: {
      displayName: "RAHMANI | RAHMANI-MD",
...
const getContextInfo = (title, url, thumb) => ({
  externalAdReply: {
    ...
    title: title,
    body: "RAHMANI-MD | Multi-Device WhatsApp Bot",
    thumbnailUrl: thumb || "https://files.catbox.moe/aktbgo.jpg",
  ...
  forwardedNewsletterMessageInfo: {
    ...
    newsletterName: 'RAHMANI-MD Updates'
  }
});
...
const customReplies = (q) => {
  ...
  if (lower.includes("Rahmani-md")) return "🔥 RAHMANI-MD is a Multi-Device WhatsApp Bot made by *RAHMANI*.";
  if (lower.includes("rahmani")) return "👑 RAHMANI is the official creator of the *RAHMANI-MD* WhatsApp bot.";
  if (lower.includes("channel")) return "📢 Official channel: https://whatsapp.com/channel/0029VatokI45EjxufALmY32X";
