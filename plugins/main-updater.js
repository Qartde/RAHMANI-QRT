...
cmd({
  ...
  alias: ["upgrade", "sync"],
  react: '🧠',
  desc: "Update RAHMANI-QRT bot from GitHub.",
  category: "system",
  filename: __filename
  ...
  try {
    await reply("🔎 Checking for RAHMANI-QRT updates...");

    const repo = "Qartde/RAHMANI-QRT";
    ...
    if (latestHash === currentHash) {
      return reply("✅ You are already using the latest version of RAHMANI-QRT!");
    }
    ...
    const sourcePath = path.join(extractPath, "RAHMANI-QRT-main");
